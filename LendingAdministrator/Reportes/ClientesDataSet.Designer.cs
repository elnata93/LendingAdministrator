...
namespace LendingAdministrator.Reportes {
    ...
    public partial class ClientesDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClientesRow AddClientesRow(string Nombres, string Apellidos, string Cedula, string Direccion, string Celular) {
...
namespace LendingAdministrator.Reportes.ClientesDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Clientes] WHERE (([ClienteId] = @Original_ClienteId) AND ((@IsNull_Nombres = 1 AND [Nombres] IS NULL) OR ([Nombres] = @Original_Nombres)) AND ((@IsNull_Apellidos = 1 AND [Apellidos] IS NULL) OR ([Apellidos] = @Original_Apellidos)) AND ((@IsNull_Cedula = 1 AND [Cedula] IS NULL) OR ([Cedula] = @Original_Cedula)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)) AND ((@IsNull_Celular = 1 AND [Celular] IS NULL) OR ([Celular] = @Original_Celular)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Clientes] ([Nombres], [Apellidos], [Cedula], [Direccion], [Celular]) VALUES (@Nombres, @Apellidos, @Cedula, @Direccion, @Celular);
SELECT ClienteId, Nombres, Apellidos, Cedula, Direccion, Celular FROM Clientes WHERE (ClienteId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Clientes] SET [Nombres] = @Nombres, [Apellidos] = @Apellidos, [Cedula] = @Cedula, [Direccion] = @Direccion, [Celular] = @Celular WHERE (([ClienteId] = @Original_ClienteId) AND ((@IsNull_Nombres = 1 AND [Nombres] IS NULL) OR ([Nombres] = @Original_Nombres)) AND ((@IsNull_Apellidos = 1 AND [Apellidos] IS NULL) OR ([Apellidos] = @Original_Apellidos)) AND ((@IsNull_Cedula = 1 AND [Cedula] IS NULL) OR ([Cedula] = @Original_Cedula)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)) AND ((@IsNull_Celular = 1 AND [Celular] IS NULL) OR ([Celular] = @Original_Celular)));
SELECT ClienteId, Nombres, Apellidos, Cedula, Direccion, Celular FROM Clientes WHERE (ClienteId = @ClienteId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ClienteId, Nombres, Apellidos, Cedula, Direccion, Celular\r\nFROM    " +
                "        Clientes";
        ...
        public virtual int Delete(int Original_ClienteId, string Original_Nombres, string Original_Apellidos, string Original_Cedula, string Original_Direccion, string Original_Celular) {
        ...
        public virtual int Insert(string Nombres, string Apellidos, string Cedula, string Direccion, string Celular) {
            if ((Nombres == null)) {
        ...
        public virtual int Update(string Nombres, string Apellidos, string Cedula, string Direccion, string Celular, int Original_ClienteId, string Original_Nombres, string Original_Apellidos, string Original_Cedula, string Original_Direccion, string Original_Celular, int ClienteId) {
            if ((Nombres == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombres, string Apellidos, string Cedula, string Direccion, string Celular, int Original_ClienteId, string Original_Nombres, string Original_Apellidos, string Original_Cedula, string Original_Direccion, string Original_Celular) {
            return this.Update(Nombres, Apellidos, Cedula, Direccion, Celular, Original_ClienteId, Original_Nombres, Original_Apellidos, Original_Cedula, Original_Direccion, Original_Celular, Original_ClienteId);
        }
    }
